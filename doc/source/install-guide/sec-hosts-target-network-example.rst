...
services" <sec-hosts-target-network-example.html#fig_hosts-target-network-containerexample>`__
and `Figure 4.3, "Target hosts for Compute
service" <sec-hosts-target-network-example.html#fig_hosts-target-network-bareexample>`__
...
.. |image2| image:: figures/3/a/a/a/rpc-common/figures/rpc9-networkarch-container-example-external.png
.. |image3| image:: figures/3/a/a/a/rpc-common/figures/rpc9-networkarch-bare-example-external.png
